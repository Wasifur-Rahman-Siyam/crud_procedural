...
$password = "";
 ...
 $query= "SELECT * FROM `catagories` WHERE soft_delete = 1;";
...
<html lang="en">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="show.php?id=<?php echo($catagorie['id']); ?>">Show</a>|<a href="restore.php?id=<?php echo($catagorie['id']); ?>" onclick="return confirm('Are you sure you want to Restore')"> Restore</a>|<a href="delete.php?id=<?php echo($catagorie['id']); ?>" onclick="return confirm('Are you sure you want to delete')"> Delete</a> </td>
