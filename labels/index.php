...
<html lang="en">
  ...
  <tbody>
    ...
    <tr>
      <td><?= ($label['title']); ?></td>
      <td><a href="show.php?id=<?php echo($label['id']); ?>">Show</a>|<a href="edit.php?id=<?php echo($label['id']); ?>"> Edit</a> |<a href="delete.php?id=<?php echo($label['id']); ?>" onclick="return confirm('Are you sure you want to delete')"> Delete</a> </td>
