              ...
              ?>
                <tr>
                  ...
                  <td><a class="btn btn-primary" href="show.php?id=<?php echo ($product['id']); ?>">Show</a>
                    |
                    <a class="btn btn-secondary" href="edit.php?id=<?php echo ($product['id']); ?>"> Edit</a>
                    |
                    <a class="btn btn-danger" href="trash.php?id=<?php echo ($product['id']); ?>" onclick="return confirm('Are you sure you want to move to trash')">Trash</a>
                  </td>
