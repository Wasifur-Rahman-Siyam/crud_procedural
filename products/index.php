...
<html lang="en">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="show.php?id=<?php echo($product['id']); ?>">Show</a>|<a href="edit.php?id=<?php echo($product['id']); ?>"> Edit</a> |<a href="delete.php?id=<?php echo($product['id']); ?>" onclick="return confirm('Are you sure you want to delete')"> Delete</a> </td>
