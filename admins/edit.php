        ...
        <div class="col-6">
          ...
          <form method="post" action="update.php" enctype="multipart/form-data" class="mt-3">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-md-10">
                <input type="text" class="form-control" id="inputemail" name="email" value="<?= $admin['email']; ?>">
              </div>
            </div>
            ...
            <div class="mb-3 row">
              ...
              <div class="col-md-10">
                <input type="text" class="form-control" id="inputpassword" name="password" value="<?= $admin['password']; ?>">
              </div>
            </div>
            ...
            <div class="mb-4">
              ...
              <div class="form-check">
                ...
                id="male" 
                name="gender" 
                value="Male" <?php if($admin['gender'] == 'Male'){ echo"checked";}?> 
