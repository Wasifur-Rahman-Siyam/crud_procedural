...
<html lang="en">
  ...
  <tbody>
    ...
    <tr>
      <td><?= ($page['title']); ?></td>
      <td><a href="show.php?id=<?php echo($page['id']); ?>">Show</a>|<a href="edit.php?id=<?php echo($page['id']); ?>"> Edit</a> |<a href="delete.php?id=<?php echo($page['id']); ?>" onclick="return confirm('Are you sure you want to delete')"> Delete</a> </td>
