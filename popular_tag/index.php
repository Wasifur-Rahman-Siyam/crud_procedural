...
$password = "";
 ...
 $query= "SELECT * FROM `popular_tag` WHERE soft_delete = 0;";
...
<html lang="en">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="show.php?id=<?php echo($popular_tag['id']); ?>">Show</a>|<a href="edit.php?id=<?php echo($popular_tag['id']); ?>"> Edit</a> |<a href="trash.php?id=<?php echo($popular_tag['id']); ?>" onclick="return confirm('Are you sure you want to delete')"> Trash</a> </td>
