...
$conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
 ...
 $query= "UPDATE `banners` SET `title` = :title , `picture` = :picture, `link` = :link, `promotional_massage` =:promotional_massage, `html_banner`= :html_banner,	`is_active` = :is_active WHERE `banners`.`id` = :id;";
