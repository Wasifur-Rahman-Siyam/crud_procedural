...
$password = "";
 ...
 $query= "SELECT * FROM `testimonial` WHERE soft_delete = 1;";
...
<html lang="en">
  ...
  <tbody>
    ...
    <td><?= ($testimonial['name']); ?></td>
      ...
      <td><a href="show.php?id=<?php echo($testimonial['id']); ?>">Show</a>|<a href="restore.php?id=<?php echo($testimonial['id']); ?>" onclick="return confirm('Are you sure you want to Restore')"> Restore</a>|<a href="delete.php?id=<?php echo($testimonial['id']); ?>" onclick="return confirm('Are you sure you want to delete permanently')"> Delete</a> </td>
