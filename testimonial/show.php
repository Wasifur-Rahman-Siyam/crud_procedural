...
$web_root='http://localhost/Pondit_Practice/crud_pondit/testimonial/Uploads/';
            ...
            <div class="row justify-content-center mt-4">
                <div class="col-md-5">
                    ...
                    <dl class="row">
                      ...
                      <dd class="col-md-10"><?= $testimonial['id']; ?></dd>
                    </dl>

                    <dl class="row">
                      <dt class="col-md-2">Picture:</dt>
                      <dd class="col-md-10"><img src="<?=$web_root . $testimonial['picture']; ?>" alt=""></dd>
                    </dl>

                    <dl class="row">
                      <dt class="col-md-2">Body:</dt>
                      <dd class="col-md-10"><?= $testimonial['body']; ?></dd>
                    </dl>

                    <dl class="row">
                      <dt class="col-md-4">Name:</dt>
                      <dd class="col-md-8"><?= $testimonial['name']; ?></dd>
                    </dl>


                    <dl class="row">
                      <dt class="col-md-4">Designation:</dt>
                      <dd class="col-md-8"><?= $testimonial['designation']; ?></dd>
                    </dl>
                    ...
                    <dl class="row">
                      ...
                      <dd class="col-md-8"><?= $testimonial['created_at']; ?></dd>
                    </dl>

                    <dl class="row">
                      <dt class="col-md-4">Modified at:</dt>
                      <dd class="col-md-8"><?= $testimonial['modified_at']; ?></dd>
                    </dl>
