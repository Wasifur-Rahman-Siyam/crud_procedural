                ...
                <div class="col-md-5">
                    ...
                    <div class="mb-3 row">
                      ...
                      <div class="col-md-10">
                        ...
                        <img src="<?=$web_root . $testimonial['picture']; ?>" alt="">
                    ...
                    <div class="mb-3 row">
                      <label for="inputbody" class="col-md-2 col-form-label">Body:</label>
                      <div class="col-md-10">
                    ...
                    <div class="mb-3 row">
                      <label for="inputdesignation" class="col-md-3 col-form-label">Designation:</label>
                      <div class="col-md-9">
