...
$password = "";
 ...
 $query= "SELECT * FROM `brands` WHERE soft_delete = 1;";
...
<html lang="en">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="show.php?id=<?php echo($banner['id']); ?>">Show</a>|<a href="restore.php?id=<?php echo($brand['id']); ?>" onclick="return confirm('Are you sure you want to Restore')"> Restore</a>|<a href="delete.php?id=<?php echo($brand['id']); ?>" onclick="return confirm('Are you sure you want to delete permanently')"> Delete</a> </td>
